...
public class UploadController {
	...
	//run configuration -> file.upload.path (c:/upload)
...
//		System.out.println(String.valueOf(file.getSize())); // log 출력 시 변환 필요할 경
		return "formUpload";
	}
 */
	@PostMapping("uploadForm")
	public String formUploadFile(@RequestPart MultipartFile[] files) { // multiple
...
//			String saveName = uploadPath + File.separator + fileName; // \/ 폴더 구분자 처리  
			String saveName = uploadPath + fileName;
			
			System.out.println("saveName : " + saveName);
			Path savePath = Paths.get(saveName); // 경로 변환
